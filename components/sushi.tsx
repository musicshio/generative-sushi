    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 space-y-12">
            ...
            <div className="space-y-3">
                <h2 className="text-lg md:text-xl font-semibold">{etymology.label}</h2>
                <p className="text-base-content/80 leading-relaxed">{etymology.description}</p>
            </div>

            <div className="space-y-3">
                <h2 className="text-lg md:text-xl font-semibold">{history.label}</h2>
            ...
            <div className="space-y-4">
                <h2 className="text-lg md:text-xl font-semibold">{recipe.label}</h2>
